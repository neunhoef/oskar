...
function launchSingleTests
  ...
  switch $launchCount
    ...
    case 24 ; test1 shell_client_aql 0 --testBuckets 5/0
    case 25 ; test1 shell_client_aql 1 --testBuckets 5/1
    case 26 ; test1 shell_client_aql 2 --testBuckets 5/2
    case 27 ; test1 shell_client_aql 3 --testBuckets 5/3
    case 28 ; test1 shell_client_aql 4 --testBuckets 5/4
    case '*' ; return 0
  end
